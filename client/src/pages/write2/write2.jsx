...
import PDF from '../../components/PDF/gappdf';
...
console.log(img);
  ...
  return (
    ...
    <>
      ...
      <PDF age={age} fullName={fullName} s1={s1} s2={s2} occupation={occupation} village={village} fatherName={fatherName} taluka={taluka} school={school}
      standard={standard} exam={exam} gapF={gapF} gapT={gapT} s3={s3} fullname2={fullname2} district1={district1} village1={village1} taluka1={taluka1}
      state1={state1} district={district} img={img}/>
    </>
