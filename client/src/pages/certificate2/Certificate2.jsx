...
import PDF from '../../components/PDF/incomePDF';
  ...
  return (
    ...
    <>
      ...
      <PDF age={age} fullName={fullName} s1={s1}  occupation={occupation} village={village} fatherName={fatherName}
       taluka={taluka} state={state} district={district} pincode={pincode} ic={ic}
      ai={ai} ic1={ic1} ai1={ai1} relation={relation} bname={bname} purpose={purpose} />
    </>
