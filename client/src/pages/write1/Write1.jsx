...
import PDF from '../../components/PDF/marathaCApdf';
...
console.log(img);
  return (
   ...
   <button style={{backgroundColor:"#000080",color:"white",fontWeight:"40px",height:"40px"}} type="submit">Submit</button>
      ...
      <PDF age={age} fullName={fullName} s1={s1} s2={s2} occupation={occupation} img={img} village={village} fatherName={fatherName} 
      taluka={taluka} state={state} district={district} pincode={pincode} s3={s3} fullname1={fullname1} village1={village1}
      state1={state1} district1={district1} taluka1={taluka1} pincode1={pincode1}/>
    </>
